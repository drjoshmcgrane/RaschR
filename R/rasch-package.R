...
#' linked frames. \code{\link{btl}} fits the comparative judgement models
#' for dichotomous and polytomous paired comparisons, and
#' \code{\link{btl_efrm}} fits their linked-frame extension.
#'

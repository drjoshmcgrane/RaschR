...
* Simulation recovery now matches EFRM and paired-comparison EFRM sets by
  their item or object membership. Renaming the same sets no longer removes
  their unit and origin recovery summaries. A genuinely different partition
  is refused rather than compared under coincidentally matching set labels.

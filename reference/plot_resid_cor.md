...
correlation seldom reaches even 0.5 under a fitting model, so the colour
is spent where the values actually discriminate. A Q3\* value of 0.2 is
sometimes used as a heuristic screen, but it is not a universal critical
value (Christensen, Makransky and Horton 2017).

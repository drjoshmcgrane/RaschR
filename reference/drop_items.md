...
silently changing its scale. Older anchored or component-constrained
fits without their original refit settings must first be refitted from
the source data. A refit is also refused if it drops or rescores a
retained item because a response category no longer contributes

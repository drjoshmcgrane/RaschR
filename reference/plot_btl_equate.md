...
shifted identity line, per-object contrast intervals at the requested
confidence level, and a dotted guide band at their average half-width;
objects that drift (after the multiplicity adjustment) are highlighted
and labelled. The counterpart of

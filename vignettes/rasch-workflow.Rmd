...
writes by hand. Under **More**, an analysis can be saved as a `.rasch`
project and reopened with its data roles and estimation settings intact, or
exported as tables, figures and an HTML, Word or PDF report.

...
(Torres Irribarra and Freund 2025). The default has no overall title and uses
one untitled person panel.
...
retains `t1`. Separate panels should be requested only when they answer a

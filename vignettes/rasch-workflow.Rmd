...
the same model. A maxT adjustment is unavailable for the complete family if
...
```{r app-items, echo = FALSE, out.width = "100%", fig.alt = "The Items panel: the item statistics table on the left with one misfitting item in red, and its item characteristic curve on the right."}

...
the traditional statistics; they open on demand rather than by default.
...
```{r app-local, echo = FALSE, out.width = "100%", fig.alt = "The Local dependence panel, showing the residual correlation matrix with the flagged pairs above the nominated threshold."}

...
(Torres Irribarra and Freund 2025). The default retains one person panel and
displays the estimated category thresholds. Separate person or item panels should be requested only when they

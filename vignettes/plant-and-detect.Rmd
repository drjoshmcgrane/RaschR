...
`sim_recovery()` compares fitted parameters with their generating values on
the same response scale and reference. In an unanchored Rasch fit, locations
are centred because the origin is arbitrary. Recovery is refused if fitting

...
| EFRM compiled-kernel parity | demonstration data, 30 seed-paired hybrid bootstrap replicates | largest absolute difference from the retained R implementation 1.31e-11 across set units, standard errors, origins, thresholds and edge likelihoods; all convergence flags agreed |

...
effects with available inference; `p` is retained as the raw probability.
...
logits, and the raw and effective judge counts in each level --- so a design
below the eight-judge boundary shows why its inference is withheld rather

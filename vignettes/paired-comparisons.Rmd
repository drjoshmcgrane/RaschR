...
When a judgment-order column is supplied, `fit$dependence` reports position,
exposure and carry-over effects together. Use `p_adj`, which applies Holm's
correction across the effects with available inference; `p` is retained as the
raw probability.

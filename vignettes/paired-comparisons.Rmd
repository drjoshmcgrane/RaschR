...
differences. Pairwise inference requires at least eight effective judges in
each level; with thinner levels, the locations and differences are reported
descriptively. The pairwise table gives the raw and effective judge counts for
both levels, so concentrated workloads remain visible.

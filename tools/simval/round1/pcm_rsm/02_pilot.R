...
for (cond in c("complete", "mcar", "booklet"))
  null_rates(cond, nrep = 5, seed0 = switch(cond, complete=10000, mcar=20000, booklet=30000))

threshold_order_rates(planted = FALSE, nrep = 5, seed0 = 40000)
threshold_order_rates(planted = TRUE,  nrep = 5, seed0 = 50000)
t1 <- Sys.time()

...
| Item fit bootstrap calibration | 8 dichotomous items, 250 to 4,000 persons (100 replicates each) | asymptotic Type I error rose with the sample for every statistic — item-trait chi-square 8.9% to 99.9%, infit z 11.5% to 68.4%, outfit z 2.4% to 29.1%, and the whole-test total 26.0% to 100% — while the fit residual’s null SD ran 0.74 to 1.00 (mean -0.11 to -0.36), leaving the conventional 2.5 cut at 0.0-1.1%. Against the bootstrap null the same statistics held at 3.1-4.8%, 4.0-14.4%, 4.0-7.1% and 2.0-5.0% |
| Item fit bootstrap power | slope 2.5 and 0.5 planted on a central item, 500 and 2,000 persons | over-discrimination detected at 1.000 by the bootstrapped chi-square at both sizes, with clean items at 0.036 and 0.037, against an asymptotic test flagging 0.091 and 0.723 of the clean items; under-discrimination is invisible to the class-interval statistic by construction (a flatter item carries less of the selection bias, so its chi-square is smaller than a fitting item’s) and is detected by the fit residual at 0.750 and 1.000 |

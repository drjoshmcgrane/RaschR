...
| Item fit bootstrap, structured designs | four-category PCM and RSM at 1,000 persons; linked booklets with informative missingness, 400 persons x 15 items, B = 600 | polytomous calibration held at 4.1-5.1% (PCM) and 5.1-5.6% (RSM); the booklet design, whose score-and-missingness tie the conditional draw preserves exactly, held 1.9% item-level with Holm familywise error of 3.0% (chi-square) and 6.0% (fit residual) |
| Person fit bootstrap | 240 persons x 12 dichotomous items, B = 99; four-category PCM at 500 persons, B = 199 | score-conditional fit-residual marginal error was 2.4% and familywise error 5.0% for the dichotomous design (100/100 analysed; all 9,900 refits usable). In the PCM top-up, marginal error was 4.25% and familywise error 7.07% (MCSE 1.9 points) among 184/200 analysed fits. Fourteen datasets had fewer than half of their refits estimable, one observed calibration was singular, and one complete adjusted family was unavailable. None of 39,601 inner refits failed to converge; 5,952 otherwise failed |
| Paired-comparison fit bootstrap | 6 objects x 20 judges; dichotomous and four-category responses | dichotomous total, pair, object and judge error was 3.0%, 3.0%, 1.0% and 3.0% (100 datasets; zero non-convergence and 38 other failures among 9,900 refits). In the 200-dataset polytomous top-up it was 3.0%, 2.0%, 7.0% and 4.5%; marginal judge error was 3.775%, with every dataset and all 39,800 refits usable (B = 199) |
| Paired-comparison fit bootstrap with history | 6 objects x 30 judges; exposure 0.5 and carry-over 0.4 fitted jointly; B = 199 | over 1,000 dichotomous datasets, total, pair-family, object-family and judge-family error was 4.8%, 3.9%, 4.8% and 5.5%, with marginal judge error 4.28%. Over 200 four-category datasets the rates were 3.0%, 3.5%, 6.0%, 6.0% and 3.65%. All 238,800 inner refits were usable |

...
| Item fit bootstrap power | slope 2.5 and 0.5 planted on a central item, 500 and 2,000 persons | the over-discriminating item reached Holm-adjusted power 0.95 at 500 persons and 1.00 at 2,000 with clean-item familywise error 3-4%, against an asymptotic test flagging 9.1% and 72.3% of the clean items; under-discrimination is invisible to the class-interval statistic by construction (a flatter item carries less of the selection bias, so its chi-square is smaller than a fitting item’s) and is caught by the fit residual at Holm-adjusted power 0.45 rising to 1.00, though a strong flat item also contaminates the fitted null enough to lift clean-item chi-square rates to 16% at 2,000 persons |

# Case study: panel and bloc frames in political paired comparisons

Paired comparisons between political parties, judged by panels during a
government crisis, fitted with the comparative-judgement frame model:
panels and party blocs carry their own units, and the script compares
bootstrap with judge-clustered standard errors on the panel-unit ratio.

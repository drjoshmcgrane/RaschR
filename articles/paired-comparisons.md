...
Residual dimensionality asks whether comparisons contain a structured
second attribute after the primary scale is fitted.
...
`btl_efrm` extends the paired-comparison model when judges belong to
panels and objects belong to linked sets whose units or origins may
differ. Cross-set comparisons establish the common scale. Without enough

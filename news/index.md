...
- [`dif_size()`](https://drjoshmcgrane.github.io/rasch/reference/dif_size.md)
  ...
  success at the item’s own location. Polytomous items are not
  classified: ETS uses a standardised mean difference in the
  observed-score metric, which is a different statistic rather than a
